                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <div id="product-images" class="carousel slide">
                              ...
                              <main id="gallery">
                                <div class="images">
                                    <img data-bs-target="#product-images" data-bs-slide-to="0" src="{{asset('/')}}images/products/{{$sp->image}}" class="img" alt="#">
                                    @php $i=1 @endphp
                                    @foreach ($sp->images as $item)
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category"><i class="lni lni-tag"></i> Category:<a href="{{$sp->category->name}}"></a></p>
                            <h3 class="price">
                            ...
                            <div class="row  align-items-end">
                                <div class="col-lg-4 col-md-4 col-12">
                                    <div class="form-group quantity">
                                        ...
                                        max="{{$sp->instock}}" ng-model="quantity">
                                    </div>
                                </div>
                            ...
                            @endauth
                                    @guest
                                        <div class="alert alert-info">
                                            Ban can <a href="{{route('login')}}">dang nhap</a> de comment
                                        </div>
                                    @endguest
                        </div>
                    </div>
